  ...
  const aiContext = useMemo(() => {
    ...
    const sectionContexts = {
      overview: {
        ...
        visualizations: ["Authorization trend", "Approved volume by channel", "Top decline drivers", "Card network mix", "Product type mix", "Domestic vs XB mix"],
        monthlyAuthorizationTrend: trend,
        channelPerformance: channelMix,
        cardNetworkMix,
        productMix,
        topDeclineDrivers: declineReasons,
        domesticXBMix: domesticXBMixData,
